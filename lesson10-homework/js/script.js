(function ($) {
    $(document).ready(function () {
        ...
        /*hometask1 lesson 10*/
        $('.lp-fb1-link').on('click', function () {
            var name = $(this).data('wi-fb-info');
            $('#lp-fb1-header').text(name + ' - ' + 'Заказать консультацию');
        });
        /*hometask2 lesson 10*/
        $('#different-input').wiFeedBack({
            fbScript: 'blocks/wi-feedback.php',
            fbLink: '.dop-info',
            fbColor: '#7952b3'
        });
        /*hometask3 lesson 10*/
        $('#enter-number').wiFeedBack({
            fbScript: 'blocks/wi-feedback.php',
            fbLink: '.dop-number',
            fbColor: '#7952b3'
        });
